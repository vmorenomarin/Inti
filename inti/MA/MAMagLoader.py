...
class MaMagLoader:
    def __init__(self,mag_dir,database_name,sep='\t', buffer_size=1024*1024, dburi='mongodb://localhost:27017/', hunabku_server = None, hunabku_apikey = None,
        ...
        self.authors_col_names = []
        self.authors_col_indexes = []
        self.instances['Authors'] = MAMagBase(mag_dir+'/Authors.txt',database_name,self.authors_col_names,self.authors_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['Affiliations'] = MAMagBase(mag_dir+'/Affiliations.txt',database_name,self.affiliations_col_names,self.affiliations_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['PaperAuthorAffiliations'] = MAMagBase(mag_dir+'/PaperAuthorAffiliations.txt',database_name,self.paper_author_affiliations_col_names,self.paper_author_affiliations_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['Papers'] = MAMagBase(mag_dir+'/Papers.txt',database_name,self.papers_col_names,self.papers_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)

        self.paper_urls_col_names = ['PaperId', 'SourceType', 'SourceUrl', 'LanguageCode']
        self.paper_urls_col_indexes = ['PaperId']
        self.instances['PaperUrls'] = MAMagBase(mag_dir+'/PaperUrls.txt',database_name,self.paper_urls_col_names,self.paper_urls_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['PaperResources'] = MAMagBase(mag_dir+'/PaperResources.txt',database_name,self.paper_resources_col_names,self.paper_resources_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)

        self.paper_references_col_names = ['PaperId', 'PaperReferenceId']
        self.paper_references_col_indexes = ['PaperId', 'PaperReferenceId']
        self.instances['PaperReferences'] = MAMagBase(mag_dir+'/PaperReferences.txt',database_name,self.paper_references_col_names,self.paper_references_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['PaperExtendedAttributes'] = MAMagBase(mag_dir+'/PaperExtendedAttributes.txt',database_name,self.paper_extended_attributes_col_names,self.paper_extended_attributes_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['Journals'] = MAMagBase(mag_dir+'/Journals.txt',database_name,self.journals_col_names,self.journals_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['ConferenceSeries'] = MAMagBase(mag_dir+'/ConferenceSeries.txt',database_name,self.conference_series_col_names,self.conference_series_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
        ...
        self.instances['ConferenceInstances'] = MAMagBase(mag_dir+'/ConferenceInstances.txt',database_name,self.conference_instances_col_names,self.conference_instances_col_indexes,sep, buffer_size, dburi, hunabku_server, hunabku_apikey,log_file, info_level)
